...
* extension[reportdetails].extension[name].valueString = "practitionerProfession"
...
* extension[reportlink][0].extension[reportelement][8].extension[order].valueInteger = 14
...
* extension[reportlink][2].extension[reportelement][1].extension[order].valueInteger = 16
...
* extension[reportlink][2].extension[reportelement][2].extension[order].valueInteger = 17
...
* extension[reportlink][2].extension[reportelement][3].extension[order].valueInteger = 18
...
* extension[reportlink][2].extension[reportelement][4].extension[order].valueInteger = 19
...
* extension[reportlink][2].extension[reportelement][5].extension[order].valueInteger = 20